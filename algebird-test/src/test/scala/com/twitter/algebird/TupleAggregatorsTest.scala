...
class TupleAggregatorsTest extends WordSpec with Matchers {
  ...
  "MultiAggregator" should {
    ...
    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 2 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple2[Long, Long], Tuple2[Long, Long]] = MultiAggregator(SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple2(6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 3 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple3[Long, Long, Long], Tuple3[Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple3(6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 4 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple4[Long, Long, Long, Long], Tuple4[Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple4(6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 5 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple5[Long, Long, Long, Long, Long], Tuple5[Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple5(6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 6 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple6[Long, Long, Long, Long, Long, Long], Tuple6[Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple6(6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 7 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple7[Long, Long, Long, Long, Long, Long, Long], Tuple7[Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple7(6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 8 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple8[Long, Long, Long, Long, Long, Long, Long, Long], Tuple8[Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple8(6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 9 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple9[Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple9[Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple9(6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 10 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple10[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple10[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple10(6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 11 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple11[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple11[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple11(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 12 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple12[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple12[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple12(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 13 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple13[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple13[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple13(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 14 HasAdditionOperatorAndZeroAggregators" in {
    ...
    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 15 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple15[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple15[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple15(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 16 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple16[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple16[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple16(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 17 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple17[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple17[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple17(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 18 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple18[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple18[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple18(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 19 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple19[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple19[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple19(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 20 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple20[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple20[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple20(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 21 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple21[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple21[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
      assert(agg(longData) == Tuple21(6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6, 6))
    }

    "Create a HasAdditionOperatorAndZeroAggregator from a tuple of 22 HasAdditionOperatorAndZeroAggregators" in {
      val agg: HasAdditionOperatorAndZeroAggregator[Long, Tuple22[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long], Tuple22[Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long, Long]] = MultiAggregator(SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg, SizeAgg)
