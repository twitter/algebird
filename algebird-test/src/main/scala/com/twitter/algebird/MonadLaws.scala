...
object MonadLaws {
  ...
  def associativeEquiv[M[_], T, U, V](implicit monad: Monad[M],
                                      arb: Arbitrary[M[T]],
                                      fn1: Arbitrary[(T) => M[U]],
                                      fn2: Arbitrary[U => M[V]],
                                      equiv: Equiv[M[V]]) =
  ...
  implicit def fnArb[M[_], T, U](implicit
                                 map: Arbitrary[Map[T, M[U]]],
                                 arbu: Arbitrary[M[U]]): Arbitrary[T => M[U]] =
    Arbitrary {
      for {
  ...
  def monadLawsEquiv[M[_], T, U, R](implicit
                                    monad: Monad[M],
                                    arb: Arbitrary[M[T]],
                                    equivT: Equiv[M[T]],
                                    equivU: Equiv[M[U]],
  ...
  def leftIdentity[M[_], T, U](implicit
                               monad: Monad[M],
                               arb: Arbitrary[T],
                               arbfn: Arbitrary[(T) => M[U]],
                               equiv: Equiv[M[U]]) =
  ...
  def associative[M[_], T, U, V](implicit monad: Monad[M],
                                 arb: Arbitrary[M[T]],
                                 fn1: Arbitrary[(T) => M[U]],
                                 fn2: Arbitrary[U => M[V]],
                                 equiv: Equiv[M[V]]) = forAll { (mt: M[T], f1: T => M[U], f2: U => M[V]) =>
