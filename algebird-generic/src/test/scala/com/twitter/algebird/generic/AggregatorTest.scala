...
abstract class ParallelAggregatorTest[
  ...
  property(s"$name: parallel aggregator product (allOf)") {
    forAll { (a1: MonoidAggregator[A1, B1, C1], a2: MonoidAggregator[A2, B2, C2], axs: List[(A1, A2)]) =>
  ...
  property(s"$name: parallel aggregator coproduct (oneOf)") {
    ...
    forAll {
      (a1: MonoidAggregator[A1, B1, C1], a2: MonoidAggregator[A2, B2, C2], axs: List[Either[A1, A2]]) =>
...
class ApplicativeAggregator_IBSLL extends ApplicativeAggregatorTest[Int, BigInt, String, Long, Long]("IBSLL")
...
abstract class JoinedAggregatorTest[
  ...
  property(s"$name: joined aggregator product (allOf)") {
    forAll { (a1: MonoidAggregator[A1, B1, C], a2: MonoidAggregator[A2, B2, C], as: List[(A1, A2)]) =>
  ...
  property(s"$name: joined aggregator product (oneOf)") {
    forAll { (a1: MonoidAggregator[A1, B1, C], a2: MonoidAggregator[A2, B2, C], as: List[Either[A1, A2]]) =>
...
abstract class CinchedAggregatorTest[
  ...
  property(s"$name: cinched aggregator product (allOf)") {
    forAll { (a1: MonoidAggregator[A1, B, C1], a2: MonoidAggregator[A2, B, C2], as: List[(A1, A2)]) =>
  ...
  property(s"$name: cinched aggregator product (oneOf)") {
    forAll { (a1: MonoidAggregator[A1, B, C1], a2: MonoidAggregator[A2, B, C2], as: List[Either[A1, A2]]) =>
...
class CinchedAggregator_ISLSB extends CinchedAggregatorTest[Int, String, Long, String, BigInt]("ISLSB")
