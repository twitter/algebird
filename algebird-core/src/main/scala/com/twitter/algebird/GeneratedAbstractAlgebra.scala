// following were autogenerated by scripts/ntuple_generators.rb at 2023-03-04 16:46:41 +0000 do not edit
...
class Tuple2Semigroup[A, B](implicit asemigroup: Semigroup[A], bsemigroup: Semigroup[B])
  ...
  override def plus(l: (A, B), r: (A, B)): (A, B) = (asemigroup.plus(l._1, r._1), bsemigroup.plus(l._2, r._2))
  override def sumOption(to: TraversableOnce[(A, B)]): Option[(A, B)] =
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple => bufA.put(tuple._1); bufB.put(tuple._2) }
...
class Tuple2Group[A, B](implicit agroup: Group[A], bgroup: Group[B])
  ...
  override def minus(l: (A, B), r: (A, B)): (A, B) = (agroup.minus(l._1, r._1), bgroup.minus(l._2, r._2))
}
...
class Tuple2Ring[A, B](implicit aring: Ring[A], bring: Ring[B]) extends Tuple2Group[A, B] with Ring[(A, B)] {
  ...
  override def times(l: (A, B), r: (A, B)): (A, B) = (aring.times(l._1, r._1), bring.times(l._2, r._2))
}
...
class Tuple3Semigroup[A, B, C](implicit
  ...
  override def sumOption(to: TraversableOnce[(A, B, C)]): Option[(A, B, C)] =
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple => bufA.put(tuple._1); bufB.put(tuple._2); bufC.put(tuple._3) }
...
class Tuple5Monoid[A, B, C, D, E](implicit
  ...
  override def zero: (A, B, C, D, E) = (amonoid.zero, bmonoid.zero, cmonoid.zero, dmonoid.zero, emonoid.zero)
}
...
class Tuple6Ring[A, B, C, D, E, F](implicit
  ...
  override def one: (A, B, C, D, E, F) = (aring.one, bring.one, cring.one, dring.one, ering.one, fring.one)
...
class Tuple7Semigroup[A, B, C, D, E, F, G](implicit
  ...
  override def sumOption(to: TraversableOnce[(A, B, C, D, E, F, G)]): Option[(A, B, C, D, E, F, G)] =
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple =>
        bufA.put(tuple._1); bufB.put(tuple._2); bufC.put(tuple._3); bufD.put(tuple._4); bufE.put(tuple._5);
        bufF.put(tuple._6); bufG.put(tuple._7)
      }
      Some(
        (
          bufA.flush.get,
...
class Tuple8Semigroup[A, B, C, D, E, F, G, H](implicit
  ...
  override def sumOption(to: TraversableOnce[(A, B, C, D, E, F, G, H)]): Option[(A, B, C, D, E, F, G, H)] =
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple =>
        bufA.put(tuple._1); bufB.put(tuple._2); bufC.put(tuple._3); bufD.put(tuple._4); bufE.put(tuple._5);
        bufF.put(tuple._6); bufG.put(tuple._7); bufH.put(tuple._8)
      }
      Some(
        (
          bufA.flush.get,
...
class Tuple9Semigroup[A, B, C, D, E, F, G, H, I](implicit
  ...
  override def sumOption(
    ...
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple =>
        bufA.put(tuple._1); bufB.put(tuple._2); bufC.put(tuple._3); bufD.put(tuple._4); bufE.put(tuple._5);
        bufF.put(tuple._6); bufG.put(tuple._7); bufH.put(tuple._8); bufI.put(tuple._9)
      }
      Some(
        (
          bufA.flush.get,
  ...
  override def sumOption(
    ...
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple =>
        bufA.put(tuple._1); bufB.put(tuple._2); bufC.put(tuple._3); bufD.put(tuple._4); bufE.put(tuple._5);
        bufF.put(tuple._6); bufG.put(tuple._7); bufH.put(tuple._8); bufI.put(tuple._9); bufJ.put(tuple._10);
        bufK.put(tuple._11); bufL.put(tuple._12); bufM.put(tuple._13)
      }
      Some(
        (
          bufA.flush.get,
  ...
  override def sumOption(
    ...
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple =>
        ...
        bufF.put(tuple._6); bufG.put(tuple._7); bufH.put(tuple._8); bufI.put(tuple._9); bufJ.put(tuple._10);
        bufK.put(tuple._11); bufL.put(tuple._12); bufM.put(tuple._13); bufN.put(tuple._14);
        bufO.put(tuple._15); bufP.put(tuple._16)
      }
      Some(
        (
          bufA.flush.get,
  ...
  override def sumOption(
    ...
    if (to.iterator.isEmpty) None
      ...
      to.iterator.foreach { tuple =>
        ...
        bufF.put(tuple._6); bufG.put(tuple._7); bufH.put(tuple._8); bufI.put(tuple._9); bufJ.put(tuple._10);
        bufK.put(tuple._11); bufL.put(tuple._12); bufM.put(tuple._13); bufN.put(tuple._14);
        bufO.put(tuple._15); bufP.put(tuple._16); bufQ.put(tuple._17)
      }
      Some(
        (
          bufA.flush.get,
