...
public class Semigroups {
  ...
  public static <T> Semigroup<scala.collection.immutable.Seq<T>> seqSemigroup() { return MODULE.seqSemigroup(); }
  public static <T> Semigroup<scala.collection.immutable.IndexedSeq<T>> indexedSeqSemigroup(Semigroup<T> componentSemigroup) { return MODULE.indexedSeqSemigroup(componentSemigroup); }
